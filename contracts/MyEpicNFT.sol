...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] thirdWords = ["Naruto", "Sasuke", "Sakura", "Ploy", "Gaara", "Minato","kakashi","Madara"];
  ...
  function makeAnEpicNFT() public {
    ...
    //limit NFT minted not over 50
    require(newItemId <= 50, "NFT limit at 50");
  ...
  function getTotalMints() public view returns (uint256) {
        console.log("We have %d total mints!", totalMint);
        return totalMint;
    }
